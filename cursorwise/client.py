...
logger = logging.getLogger("cursorwise.client")
...
class FlowiseClient:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        self._client = httpx.AsyncClient(
            ...
            # Bypass corporate proxy for local Flowise calls
            proxy=None,
        )
    ...
    async def create_chatflow(
        ...
        if flow_data:
            payload["flowData"] = flow_data  # Already a JSON string per Flowise spec
